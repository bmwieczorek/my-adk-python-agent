...
ADK_WEB_URL="https://${APP_NAME}-${GKE_NAMESPACE}.${GKE_CLUSTER_SUBDOMAIN_INFIX}.${GKE_CLUSTER_REGION}.${GKE_HTTP_URL_DOMAIN}"
A2A_ENDPOINT_URL="https://${APP_NAME}-a2a-${GKE_NAMESPACE}.${GKE_CLUSTER_SUBDOMAIN_INFIX}.${GKE_CLUSTER_REGION}.${GKE_HTTP_URL_DOMAIN}"

echo "ADK Web URL: ${ADK_WEB_URL}"
echo "A2A Endpoint URL: ${A2A_ENDPOINT_URL}"
echo "A2A Agent Card URL: ${A2A_ENDPOINT_URL}/.well-known/agent-card.json"
